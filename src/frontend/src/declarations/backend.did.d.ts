...
export interface _SERVICE {
  ...
  'createArticle' : ActorMethod<[string, string, string], undefined>,
  'fetchFinancialNews' : ActorMethod<[string], string>,
  'fetchMarketSummary' : ActorMethod<[], string>,
  'fetchStockQuote' : ActorMethod<[string], string>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getOwnArticles' : ActorMethod<[], Array<Article>>,
