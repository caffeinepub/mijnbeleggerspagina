...
export class Backend implements backendInterface {
    ...
    async createArticle(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async fetchFinancialNews(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchFinancialNews(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchMarketSummary(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchMarketSummary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchStockQuote(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchStockQuote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOwnArticles(): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnArticles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
